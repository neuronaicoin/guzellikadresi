  ...
  return (
    <>
      ...
      <div className="ga-static-wrap">
        ...
        <p>GüzellikAdresi, güzellik ve bakım işletmelerini kullanıcılarla buluşturan bir rehber platformudur. Platform, işletmeler ile kullanıcılar arasında aracılık yapmaz; yalnızca bilgi sunar.</p>
        ...
        <p>Platformdaki tüm içerik ve tasarım GüzellikAdresi'ne aittir. İzinsiz kopyalanamaz veya çoğaltılamaz. İşletmelerin yüklediği fotoğraf ve içeriklerin sorumluluğu ilgili işletmeye aittir.</p>

        <h2>Değişiklikler</h2>
        <p>GüzellikAdresi, bu şartları önceden haber vermeksizin güncelleme hakkını saklı tutar.</p>
