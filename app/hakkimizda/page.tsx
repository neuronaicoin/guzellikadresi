...
export const metadata = {
  title: 'Hakkımızda',
  description: "GüzellikAdresin, Türkiye genelinde güzellik ve bakım işletmelerini müşterilerle buluşturan ücretsiz bir rehberdir.",
};
  ...
  return (
    <>
      ...
      <div className="ga-static-wrap">
        ...
        <h2>Biz Kimiz?</h2>
        <p>GüzellikAdresin, Türkiye genelinde güzellik merkezi, kuaför, medikal estetik, tırnak stüdyosu, saç ekimi ve daha birçok güzellik & bakım hizmetini tek çatı altında buluşturan ücretsiz bir rehberdir. Amacımız, hizmet arayan kişileri bulundukları bölgedeki güvenilir uzmanlarla kolayca buluşturmak.</p>

        <h2>Neden GüzellikAdresin?</h2>
